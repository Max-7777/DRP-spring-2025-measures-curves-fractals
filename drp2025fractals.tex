...
\begin{definition}[Interval length]
	...
	\[|I| := b - a\]
\end{definition}
This is intuitive and useful. But how can this be justified with some definition of measure? And how can the idea of length be defined in a more general way? 
...
\begin{example}[Open covering for an interval]
	...
	\\[0.2in]You could say that $C$ is ``overkill'' as an open cover for $I$ since it spans a much longer length than $I$. In this case, the length of $I$ is
	\[|I| = 3 - 1 = 2\]
...
\begin{example}[Stick cutting]
	...
	\\[0.2in]Another object which represents this length value is
	...
	\begin{proof}
		...
		by the definition of length and the intervals. So we have
