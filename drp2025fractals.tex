...
\section{Cantor Set}
	...
	\\Cantor Set visualized in 2D with 10 iterations. For each interval $[a,b]$, there is a colored box positioned at $(a,a)$ with size $(3^{-k}, 3^{-k})$, where $k$ is the iteration. 
