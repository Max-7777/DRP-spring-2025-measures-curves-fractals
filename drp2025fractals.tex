...
\begin{example}[Open covering for an interval]
	...
	\\[0.2in]You could say that $C$ is ``overkill'' as an open cover for $I$ since it spans a much longer length than $I$. In this case, the length of the open cover $\bigcup_{i=1}^{3} C_i$ is
	\[100 - (-50) = 150\]
